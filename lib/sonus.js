...
const sonusPath = path.dirname(require.resolve('sonus'));
...
class Sonus extends EventEmitter {
    constructor(options) {
        ...
        const hotwords = [
            {file: options.model || path.join(snowboyPath, '/resources/models/snowboy.umdl'), hotword: options.model ? 'hotword' : 'snowboy'},
